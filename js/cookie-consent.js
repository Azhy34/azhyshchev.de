(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      '  border-top:2px solid #f5c84b;',
      '  padding:12px 180px 12px 20px;',
      '  display:flex;align-items:center;gap:16px;flex-wrap:wrap;',
      '}',
      '#cc-banner .cc-text{flex:1;min-width:180px;font-size:0.75rem;font-weight:600;line-height:1.4;}',
      '#cc-banner .cc-text a{color:#f5c84b;text-underline-offset:3px;}',
      '#cc-banner .cc-btns{display:flex;gap:8px;flex-wrap:wrap;align-items:center;}',
      '.cc-btn{',
      '  font-family:"JetBrains Mono",monospace;font-weight:800;font-size:0.75rem;',
      '  padding:7px 14px;border:2px solid;cursor:pointer;',
      ...
      '  #cc-banner{flex-direction:column;align-items:stretch;padding:12px 16px;}',
      '  #cc-banner .cc-btns{flex-direction:row;flex-wrap:wrap;}',
      '  .cc-btn{text-align:center;flex:1;}',
