(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      '  box-shadow:0 -4px 0 #f5c84b;',
      '  padding:20px 24px;',
      '  display:flex;align-items:center;gap:24px;flex-wrap:wrap;',
      '}',
      '#cc-banner .cc-text{flex:1;min-width:220px;font-size:0.82rem;font-weight:600;line-height:1.5;}',
      '#cc-banner .cc-text a{color:#f5c84b;text-underline-offset:3px;}',
      '#cc-banner .cc-btns{display:flex;gap:10px;flex-wrap:wrap;align-items:center;}',
      '.cc-btn{',
      '  font-family:"JetBrains Mono",monospace;font-weight:800;font-size:0.82rem;',
      '  padding:10px 18px;border:2px solid;cursor:pointer;',
      ...
      '  #cc-banner .cc-btns{flex-direction:column;}',
