(function () {
  ...
  function injectStyles() {
    var css = [
      ...
      '}',
      '#cc-banner .cc-text{font-size:0.72rem;font-weight:600;line-height:1.4;white-space:nowrap;}',
      ...
      '  #cc-banner{max-width:calc(100vw - 32px);flex-wrap:wrap;}',
      '  #cc-banner .cc-text{white-space:normal;}',
